    ...
    <header>
      ...
      <div>
        <div className="minimize-btn" onClick={() => setIsChatSectionOpen((prev:boolean) => !prev)}>
          <svg viewBox="0 0 150 150" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M4 107V14C4 12.3431 5.34315 11 7 11H74.7603H142.567C144.205 11 145.541 12.3151 145.566 13.9538L147 107" stroke="white" stroke-dasharray="2 2"/>
          ...
          <rect x="8" y="110" width="55" height="16" rx="8" fill="black" fill-opacity="0.34"/>
          <rect x="105" y="111" width="14" height="14" rx="7" fill="black" fill-opacity="0.34"/>
          <path d="M126 117.5C126 113.91 128.91 111 132.5 111C136.09 111 139 113.91 139 117.5V118.5C139 122.09 136.09 125 132.5 125C128.91 125 126 122.09 126 118.5V117.5Z" fill="black" fill-opacity="0.34"/>
          </svg>
        </div>
